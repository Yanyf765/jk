    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><textarea name="crequest" style="height:90px;">${obj.crequest}</textarea></td>
	            <td class="columnTitle_mustbe">说明：</td>
	            <td class="tableContent"><textarea name="remark" style="height:90px;">${obj.remark}</textarea></td>
	        </tr>
		</table>
	</div>
</div>
