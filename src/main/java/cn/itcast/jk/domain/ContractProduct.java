...
public class ContractProduct {
	private String id;//合同货物id
	private String contractId;//将复杂的关联关系变成单表操作,关联关系的表(外键),都成为普通字段
	private String factoryId;//货号
	private String factoryName;//货物照片
	private String productNo;//货物描述
